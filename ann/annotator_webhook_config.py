...
class Config(object):
    ...
    # AWS SNS topics
    AWS_SNS_TOPIC = f"arn:aws:sns:us-east-1:127134666975:{iam_username}_a16_job_requests"

    # AWS SQS queues
    AWS_QUEUE_URL = f"https://sqs.us-east-1.amazonaws.com/127134666975/{iam_username}_a16_job_requests"
